...
window.configure(background='#f0f0f0')  # Light Graywindow.configure(background='grey80')
    ...
    def fill_attendance():
        ...
        if subb == '':
            ...
            def create_csv():
                ...
                csv_name = rf'E:\Attendance Management System using Face Recognition\Attendance\Manually Attendance{DB_table_name}.csv'
            ...
            def attf():
                import subprocess
                subprocess.Popen(
                    r'E:\Attendance Management System using Face Recognition\Attendance\Manually Attendance-------Check atttendance-------"')
    ...
    def Fillattendances():
        ...
        if time.time() < future:
            if sub == '':
                ...
                root.configure(background='grey80')
                cs = 'E:\Attendance Management System using Face Recognition' + fileName
...
message = tk.Label(window, text="Attendance Management System using Face Recognition",align= "center", bg="#3498db", fg="white", width=50,
